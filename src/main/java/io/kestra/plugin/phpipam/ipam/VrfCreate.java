    ...
    examples = {
        @Example(
            ...
            code = """
                ...
                tasks:
                  - id: create_vrf
                    type: io.kestra.plugin.phpipam.ipam.VrfCreate
...
public class VrfCreate extends AbstractPhpipamTask implements RunnableTask<VrfCreate.Output> {
    ...
    public Output run(RunContext runContext) throws Exception {
        ...
        var id = client.post("vrf/", body, new TypeReference<PhpipamEnvelope<String>>() {});
