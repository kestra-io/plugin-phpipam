    ...
    examples = {
        @Example(
            ...
            code = """
                ...
                tasks:
                  - id: create_subnet
                    type: io.kestra.plugin.phpipam.ipam.SubnetCreate
...
public class SubnetCreate extends AbstractPhpipamTask implements RunnableTask<SubnetCreate.Output> {
    ...
    public Output run(RunContext runContext) throws Exception {
        ...
        var id = client.post("subnets/", body,
