    ...
    examples = {
        @Example(
            ...
            code = """
                ...
                tasks:
                  - id: list_vrfs
                    type: io.kestra.plugin.phpipam.ipam.VrfList
...
public class VrfList extends AbstractPhpipamTask implements RunnableTask<VrfList.Output> {

    @Override
    public Output run(RunContext runContext) throws Exception {
        var client = buildClient(runContext);
        var vrfs = client.get("vrf/", new TypeReference<PhpipamEnvelope<List<Vrf>>>() {});
