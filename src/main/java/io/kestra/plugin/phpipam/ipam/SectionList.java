    ...
    examples = {
        @Example(
            ...
            code = """
                ...
                tasks:
                  - id: list_sections
                    type: io.kestra.plugin.phpipam.ipam.SectionList
...
public class SectionList extends AbstractPhpipamTask implements RunnableTask<SectionList.Output> {

    @Override
    public Output run(RunContext runContext) throws Exception {
        var client = buildClient(runContext);
        var sections = client.get("sections/",
            new TypeReference<PhpipamEnvelope<List<Section>>>() {});
